...
from sqlalchemy import DateTime, Enum as SAEnum, Text, ForeignKey, Numeric, JSON, String
...
class Encounter(Base):
    ...
    queue_status: Mapped[str] = mapped_column(String(30), nullable=False, default="waiting")
...
class ClinicalNote(Base):
    ...
    chief_complaint: Mapped[str | None] = mapped_column(Text, nullable=True)
    history_present_illness: Mapped[str | None] = mapped_column(Text, nullable=True)
